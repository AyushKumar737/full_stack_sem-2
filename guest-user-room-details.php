            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="guest-user-package-details.php" class="nav-item nav-link " style="margin-right:20px;"><i class="fa-solid fa-earth-asia" style="margin-right:5px;"></i>Tour Packages</a>
                        <a href="guest-user-room-details.php" class="nav-item nav-link active" style="margin-right:20px;"><i class="fa-solid fa-hotel" style="margin-right:5px;"></i>Room Services</a>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="room-item shadow rounded overflow-hidden">
                                <div class="position-relative">
                                    <img class="img-fluid" src="img/<?php echo $row['image']; ?>" alt="Network Error">
                                </div>
                                <div class="p-4 mt-2">
