...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">All Destination</h6>
                        <!-- <a href="">Show All</a> -->
                    </div>
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td>" . $row["name"] . "</td>
                                        <td>" . $row["image"] . "</td>
                                        <td><a class='btn btn-success btn-sm' href='destination_edit.php?id=$row[id]'>Edit</a></td>
                                        <td><a class='btn btn-danger btn-sm' href='destination-delete.php?id=$row[id]'>Delete</a></td>
                                    </tr>";
                                }
                                ?>
                            </tbody>
            ...
            <!-- Footer Start -->
            <div class="container-fluid pt-4 px-4" style="margin-top:195px;">
