                ...
                <nav class="navbar bg-secondary navbar-dark">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="admin-blank.php" class="nav-item nav-link active"></i>Add admin</a>
            ...
            <div class="content">
                ...
                if (isset($_POST["add"])) {
                    ...
                    if (count($errors) > 0) {
                        ...
                        $sql = "INSERT INTO admin (Username,Image,mobile,email, Password,admin_role) VALUES ( ?, ?, ?, ? ,? , ? )";
                        $stmt = mysqli_stmt_init($conn);
                        $preparestmt = mysqli_stmt_prepare($stmt, $sql);

                        if ($preparestmt) {
                            mysqli_stmt_bind_param($stmt, "ssssss", $Username, $Image, $mobile, $email, $password, $admin_role);
                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-6">
                            <div class="bg-secondary rounded h-100 p-4">
                                ...
                                <form action="admin-blank.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="formFileMultiple" class="form-label">Select Images for Admin</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="mobile" class="form-control" id="inputEmail3">
                                    ...
                                    <div class="mb-3">
                                        <label for="packagename" class="form-label">confirm Password</label>
                                        <input type="password" name="rpassword" class="form-control" id="inputEmail3">
