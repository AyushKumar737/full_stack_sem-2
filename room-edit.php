                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="room-edit.php" class="nav-item nav-link active">view Room</a>
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td><a class='btn btn-success btn-sm' href='room-update.php?id=$row[id]'>Edit</a></td>
                                        <td><a class='btn btn-danger btn-sm' href='room-delete.php?id=$row[id]'>Delete</a></td>
                                    </tr>";
                                }
                                ?>
                            </tbody>
