    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                ...
                $query = "SELECT * FROM hill_destination";
                ...
                ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="<?php echo $row['image']; ?>" alt="Network Error" style="width: 500px; height:230px;">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                        <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i><?php echo $row['name']; ?></small>
                                        <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i><?php echo $row['days']; ?></small>
                                        </div>
                                    <a class="h5 text-decoration-none" href="package-details.php?Id=<?php echo $row['id']; ?>"><?php echo $row['description']; ?></a>
