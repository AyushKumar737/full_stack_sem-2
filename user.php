                ...
                <div class="col-lg-6 text-center text-lg-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        if ($row) {
                            //foreach ($rows as $row) {               
                        ?>
                            <a class="text-primary px-3" href="profile_with_data_and_skills.php">
                                <i class="fa-solid fa-user"></i>
                            </a>
                           <h5 style="margin: 5px;"> <?php echo $row['fname']; ?> <?php echo $row['lname']; ?></h5>
                        <?php $cnt = $cnt + 1;
                        }
                        ?>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="user.php" class="nav-item nav-link active"><i class="fa-solid fa-house-chimney" style="margin-right:5px;"></i>Home</a>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
                            <h1 class="display-3 text-white mb-md-4">Collect Moment Not Things.</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
                            <h1 class="display-3 text-white mb-md-4">Travel Far Enough To Find Yourself.</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
                            <h1 class="display-3 text-white mb-md-4">It Is Better To Travel Well than to arrive.</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            <h5 class="">Over India Coverage</h5>
                            <p class="m-0">Magna sit magna dolor duo dolor labore rebum amet elitr est diam sea</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                ...
                <h1>Explore Top Six Package Destination's</h1>
            </div>
            <div class="row">
                ...
                ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                ...
                                <a class="destination-overlay text-white text-decoration-none" href="package-details.php?dId=<?php echo $row['id']; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="container-fluid py-5">
                                <div class="container py-5">
                                    ...
                                    <?php
                                    $feedquery = "SELECT * FROM feedback where show_feedback=1 Limit 6";
                                    $feedquery_run = mysqli_query($conn, $feedquery);

                                    $check_feedback = mysqli_num_rows($feedquery_run) > 0;

                                    if ($check_feedback) {
                                        while ($feedrow = mysqli_fetch_assoc($feedquery_run)) {
                                    ?>
                                            <div style="width: 400px; margin-top:50px; display:inline-block;">
                                                <div class="text-center pb-4">
                                                    <div class="testimonial-text bg-white p-4 mt-n5">
                                                        <p class="mt-5"><?php echo $feedrow['message']; ?>
                                                        </p>
                                                        <h5 class="text-truncate"><?php echo $feedrow['fname']; ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                    <?php  }
