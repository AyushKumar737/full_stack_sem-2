...
<body>
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>View Packages</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="admin-view-pakage.php" class="nav-item nav-link active">view user booking</a>
        ...
        <div class="content">
            ...
            <div class="col-sm-12 col-xl-6 contain">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">View User's Booking</h6>
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<tr>
                                        ...
                                        <td>" . $row["price"] . "</td>
                                        <td>" . $button . "</td>
                                        <td><a class='btn btn-danger btn-sm' href='user-booking-delete.php?p_id=$row[p_id]'>Delete</a></td>
                                    </tr>";
                            }
                            ?>
                        </tbody>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            Designed By <a href="S">Ayush & Manav</a>
