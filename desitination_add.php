...
<body>
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="desitination_add.php" class="nav-item nav-link active"></i>Add Destination</a>
        ...
        <div class="content">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Form to add Destination</h6>
                            ...
                            if (!empty($_POST)) {
                                ...
                                include("connection.php");
                                $stmt = $conn->prepare("INSERT INTO destination (name , image) VALUES (?, ?)");
                            ...
                            <form action="desitination_add.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
            ...
            <!-- Footer Start -->
            <div class="container-fluid pt-4 px-4" style="margin-top:312px;">
